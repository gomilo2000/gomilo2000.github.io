...
export default function Footer() {
  return (
    <footer style={{ padding: '40px 48px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 24, flexWrap: 'wrap', borderTop: '1px solid rgba(15,20,40,.06)', borderRadius: '0 0 28px 28px' }}>
      <div>
